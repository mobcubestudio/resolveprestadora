...
<head>
    ...
    <style>
        ...
        h2.active {
            color: #0d0d0d;
            border-bottom: 2px solid #133901;
        }
        ...
        input[type=text]:focus, input[type=password]:focus {
            ...
            border-bottom: 2px solid #4cb420;
        }
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <img src="{{asset('images/logo.jpg')}}" id="icon" alt="Resolve - Login" style="width: 150px" />
            </div>
            ...
            <form action="{{ route('admin.login.do') }}" method="post">
                @csrf
                <input type="text" id="login" class="fadeIn second" name="matricula" placeholder="Matrícula">
