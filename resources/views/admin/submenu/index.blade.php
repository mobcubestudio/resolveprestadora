    ...
    <table class="table table-hover table-striped table-responsive">
        ...
        <tbody>
            ...
            <tr class="align-middle">
                ...
                <td class="text-center">
                    <a href="{{route("admin.$model.form.edit",["$var"=>$data])}}"  class="icon-action" id="editar" id-purchase="{{$data->id}}" style="margin-right: 0em"  data-bs-toggle="tooltip" data-bs-placement="top" title="Editar: {{$data->name}}">
